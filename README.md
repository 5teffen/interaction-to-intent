# From Interaction to Intent — reproduction code
...
This repo contains **only code**. The dataset (interaction sequences and projection
coordinates) is downloaded from Zenodo by `make data`. Everything under `data/`, plus
checkpoints, generated features, figures, and ablation outputs, is regenerated by the pipeline
and gitignored.
